...
function App(props) {
  ...
  // // Then read your DAI balance like:
   ...
   //attempt to read from defipulse contract:
   ...
   const myDefiPulseName = useContractReader({DPI: defi_pulse_contract},"DPI", "name")
   console.log("🥇 Defi Pulse Name:",myDefiPulseName)
